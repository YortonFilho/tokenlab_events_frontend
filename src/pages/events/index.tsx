...
export function Events() {
  ...
  const createEvent = (e: React.FormEvent) => {
    ...
    const url = editEvent
      ? `http://localhost:3333/events/${editEvent.id}`
    ...
    fetch(url, {
      ...
      .catch((error) => {
        ...
        console.error("Erro criar/atualizar evento:", error);
      });
  };
    ...
    <div className="events">
      ...
      <section className="events-section">
        <div className="my-events">
          ...
          <button className="create-event" onClick={toggleSheet}>
            Criar evento
          </button>
        </div>
        ...
        <div className={`event-sheet ${isSheetOpen ? "open" : ""}`}>
          <div className="sheet-content">
            ...
            <form className="event-form" onSubmit={createEvent}>
              ...
              <button type="button" className="close-btn" onClick={toggleSheet}>
                Fechar
              </button>
            </form>
          </div>
